            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a data-toggle="modal" href="#modal_superusers" id="delete"  class="btn btn-info" name=""><i class="fa fa-plus"></i> Add Status</a><br><br>
                  <?php include('modal_status.php') ?> <br> 
                    <!-- content -->
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php
                          $query = $conn->query("select * from statpercent") or die(mysql_error());
